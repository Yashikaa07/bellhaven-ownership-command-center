...
.stApp{background:linear-gradient(120deg,#e9faf3 0,#f5f8fb 24%,#f5f8fb 100%);color:#182235}.block-container{padding:4.75rem 2.1rem 3rem;max-width:1440px}
...
.eyebrow{color:#07805c!important;opacity:1;font-size:10px;font-weight:700;letter-spacing:.16em;text-transform:uppercase;margin-top:5px}.hero{font:700 31px/1.08 'Space Grotesk';margin:5px 0 7px;color:#172033;white-space:normal}.sub{color:#6b778a;font-size:14px;margin-bottom:14px;max-width:920px}
...
@media(max-width:900px){.block-container{padding:4.5rem 1rem 2rem}.brief-grid{grid-template-columns:1fr;gap:12px}.brief-item{padding:4px 12px}.hero{font-size:26px}}
